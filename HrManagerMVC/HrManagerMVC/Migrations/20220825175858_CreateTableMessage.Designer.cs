...
namespace HrManagerMVC.Migrations
{
    ...
    [Migration("20220825175858_CreateTableMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrManagerMVC.Models.SendMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HrManagerMVC.Models.SendMessage", b =>
                {
                    b.HasOne("HrManagerMVC.Models.AppUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId");

                    b.HasOne("HrManagerMVC.Models.AppUser", "ToUser")
                        .WithMany()
